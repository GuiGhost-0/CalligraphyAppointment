...
<div>
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/admin_updateAdmin.action">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input  type="text" class="form-control" id="inputname" name="name" value="${adminMana.name}" placeholder="name">
            </div>
        </div>
        <div class="form-group">
            <label for="inputoldpwd" class="col-sm-2 control-label">旧密码</label>
            <div class="col-sm-10">
                <input type="password" class="form-control" id="inputoldpwd" name="adminPassword" value="${adminMana.adminPassword}" placeholder="OldPassword">
            </div>
        </div>
        <div class="form-group">
